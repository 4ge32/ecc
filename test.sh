...
if [ $# = 1 ]; then
  if [ $1 = 'now' ]; then
    ...
    #./ecc 'int main() {return 2 * 3 + 4 * 5;}' -debug
    #./ecc 'int main() {a = 2; b = 3; return a * b;}' -debug
    #./ecc 'int main() {return 1 == 1;}' -debug
    #./ecc 'int main() {return 1 != 1;}' -debug
    #./ecc 'int main() {return 0 < 1;}' -debug
    #./ecc 'int main() {return 0 <= 1;}' -debug
    #./ecc 'int main() {if (1 <= 2) return 10; return 0;}' -debug
    #./ecc 'int main() {a = 2; b= 3; if (a < b) return 10; return 0;}' -debug'
    ./ecc 'int main() {return 1 == 1;}' -debug
    #./ecc 'int main() {if (1) { a = 2; b = 3; } else {a = 10; b = 20; } return a + b;}' -debug
    #./ecc 'int main() {if (1 <= 2) {return 2;} else {return 3;}}' -debug
  else
    #./ecc 'int main() {a = 2; b = 3; return a * b;}' -debug > tree/seed.txt
    #./ecc 'int main() {return 2 * 3 + 4 * 5;}' -debug > tree/seed.txt
    ./ecc 'int main() {return 1 == 1;}' -debug
    #./ecc 'int main() {return 1 != 1;}'
    #./ecc 'int main() {return 0 < 1;}'
    #./ecc 'int main() {return 0 <= 1;}'
    #./ecc 'int main() {return 1 < 0;}'
    #./ecc 'int main() {return 1 <= 0;}'
    #./ecc 'int main() {if (1 <= 2) return 10; return 0;}'
    #./ecc 'int main() {if (1 < 2) return 10; return 0;}'
    #./ecc 'int main() {a = 2; b= 3; if (a < b) return 10; return 0;}'
    cat tree/seed.txt | grep -n "PARSE" | awk -F: '{print "sed -i -e "1","$1"d " "tree/seed.txt"}' |  bash
    python tree/test.py
    fi
  exit 0
fi
...
try 1 'int main() { if (1 == 1) {return 1;} else { return 5;}}'
try 5 'int main() { if (1 == 0) {return 1;} else { return 5;}}'
